...
function Modal() {
  ...
  const [addTaskToDB, newTaskInput , setNewTaskInput ,image, setImage ,newTaskType]=useBoardStore((state)=>[
    state.addTaskToDB,
    state.newTaskInput,
  ...
  const handleSubmit=(e: FormEvent<HTMLFormElement>)=>{
     ...
     // add task to db
     addTaskToDB(newTaskInput , newTaskType,image);
     setImage(null);
     closeModal();
  }
  return (
                  ...
                  <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                    ...
                    <TaskTypedRadioGroup/>
                     ...
                     <div className="">
                        ...
                        }} className='w-full boarder border-gray-300 rounded-md outline-none p-5 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2'>
                        ...
                        <input type="file" ref={imagePickerRef} hidden 
                        onChange={(e)=>{
                            // check e is an image
