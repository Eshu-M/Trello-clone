...
export async function POST(request:Request) {
    ...
    const response = await openai.chat.completions.create({
        ...
        messages:[
            ...
            {
                "role":'user',
                "content":"Hi there , provide a summery of the following todos . Count how many todos are in each category such as To do , in progress and done ,  then tell the user to have a productive day here is the data",
            }
        ],
        stream:false,
    })
